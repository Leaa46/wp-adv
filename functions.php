...
function wp_adv_register_styles(){
    ...
    wp_enqueue_style('wp_adv_style', get_stylesheet_uri(), ['wp_adv_bootstrap'], '1.0', 'all');
     wp_enqueue_style( 'wp_adv_fontawesome', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/7.0.1/css/all.min.css', [], '7.0.1', 'all');
     }
